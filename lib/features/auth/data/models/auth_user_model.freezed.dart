...
mixin _$AuthUserModel {
 ...
 String get id;@JsonKey(name: 'full_name') String get name; String get email; String get role;@JsonKey(name: 'role_display') String get roleDisplay; List<String> get permissions;
...
@override
String toString() {
  return 'AuthUserModel(id: $id, name: $name, email: $email, role: $role, roleDisplay: $roleDisplay, permissions: $permissions)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'full_name') String name, String email, String role,@JsonKey(name: 'role_display') String roleDisplay, List<String> permissions
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'full_name')  String name,  String email,  String role, @JsonKey(name: 'role_display')  String roleDisplay,  List<String> permissions)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthUserModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'full_name')  String name,  String email,  String role, @JsonKey(name: 'role_display')  String roleDisplay,  List<String> permissions)  $default,) {final _that = this;
switch (_that) {
case _AuthUserModel():
return $default(_that.id,_that.name,_that.email,_that.role,_that.roleDisplay,_that.permissions);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'full_name')  String name,  String email,  String role, @JsonKey(name: 'role_display')  String roleDisplay,  List<String> permissions)?  $default,) {final _that = this;
switch (_that) {
case _AuthUserModel() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.role,_that.roleDisplay,_that.permissions);case _:
  return null;
...
class _AuthUserModel extends AuthUserModel {
  const _AuthUserModel({required this.id, @JsonKey(name: 'full_name') required this.name, required this.email, required this.role, @JsonKey(name: 'role_display') required this.roleDisplay, final  List<String> permissions = const <String>[]}): _permissions = permissions,super._();
